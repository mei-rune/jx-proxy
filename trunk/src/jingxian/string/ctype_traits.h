...
struct ctype_traits<char_t>
{
    ...
    static bool    is_upper(char_type ch)
    {
        return 0 != ::isupper(ch);
    }
    static bool    is_lower(char_type ch)
    {
        return 0 != ::islower(ch);
    }
    ...
    static bool    is_xdigit(char_type ch)
    {
    ...
    static bool    is_punct(char_type ch)
    {
        return 0 != ::ispunct(ch);
    }
    static bool    is_alnum(char_type ch)
    {
        return 0 != ::isalnum(ch);
    }
    static bool    is_print(char_type ch)
    {
        return 0 != ::isprint(ch);
    }
    static bool    is_graph(char_type ch)
    {
        return 0 != ::isgraph(ch);
    }
    static bool    is_cntrl(char_type ch)
    {
        return 0 != ::iscntrl(ch);
    }
...
struct ctype_traits<wchar_t>
{
    ...
    static bool    is_alpha(char_type ch)
    {
        return 0 != ::iswalpha(ch);
    }
    static bool    is_upper(char_type ch)
    {
        return 0 != ::iswupper(ch);
    }
    static bool    is_lower(char_type ch)
    {
        return 0 != ::iswlower(ch);
    }
    static bool    is_digit(char_type ch)
    {
        return 0 != ::iswdigit(ch);
    }
    static bool    is_xdigit(char_type ch)
    {
    ...
    static bool    is_space(char_type ch)
    {
        return 0 != ::iswspace(ch);
    }
    static bool    is_punct(char_type ch)
    {
        return 0 != ::iswpunct(ch);
    }
    static bool    is_alnum(char_type ch)
    {
        return 0 != ::iswalnum(ch);
    }
    static bool    is_print(char_type ch)
    {
        return 0 != ::iswprint(ch);
    }
    static bool    is_graph(char_type ch)
    {
        return 0 != ::iswgraph(ch);
    }
    static bool    is_cntrl(char_type ch)
    {
        return 0 != ::iswcntrl(ch);
    }
